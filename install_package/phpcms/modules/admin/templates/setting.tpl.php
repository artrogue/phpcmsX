        ...
        <table width="100%"  class="table_form">
            <tr>
                ...
                <td class="y-bg" width="200">
                    <input type="radio" name="setconfig[cwsapi]" value="0"<?php if($cwsapi==0){echo ' checked';}  ?>> 讯飞接口&nbsp;&nbsp;
                </td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="y-bg" width="200">
                    <input type="radio" name="setconfig[cwsapi]" value="1"<?php if($cwsapi==1){echo ' checked';}  ?>> 百度接口&nbsp;&nbsp;
                </td>
                <td></td>
            </tr>
            <tr>
